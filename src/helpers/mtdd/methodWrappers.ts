 ...
 */
export function createMtddMethodWrapper(originalMethod: Function, methodName: string) {
 ...
 */
export function createReRunMethodWrapper(originalMethod: Function, methodName: string) {
  return function (this: any, ...args: any[]): any {
    const result = originalMethod.apply(this, args);
